"""
ECFFT Parameters — Curve with 2^20 cyclic subgroup over BN-254 base field
===========================================================================
...
whose group  E(Fq)  contains a cyclic subgroup of order  2^20 = 1048576.
...
20 good isogenies that drive the ECFFT recursion.
...
Found by random search over BN-254 base field.
    ...
    B  = 4017660946671215398527212635155410452720141402746418430734298542572364476330

    Generator point (order 2^20):
    G  = (72741324573834444051481096350144623350770302488412565367468391337396010612,
          1735668802666030810767374651871167187380082049253283735063130026458754200195)
...
def verify():
    ...
    Verify that the parameters are correct:
      ...
      3. The generator has order exactly 2^20
