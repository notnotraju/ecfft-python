"""
ECFFT Parameters — Curve with 2^19 cyclic subgroup over BN-254 base field
===========================================================================
...
whose group  E(Fq)  contains a cyclic subgroup of order  2^19 = 524288.
...
19 good isogenies that drive the ECFFT recursion.
...
Found by random search over BN-254 base field.
    ...
    B  = 7045312493309525668369461691598070878448993674248805428332703556156728537593

    Generator point (order 2^19):
    G  = (4829453208919067402500883847334816322244746888452843309002692632160138992140,
          18907995215076895123251380389023476008045611862057851369609315058508855857578)
...
To verify these parameters:
    ...
    >>> from ecfft_params_2_19 import params, verify
    >>> verify()
    True
...
To run the ECFFT demo:
    ...
    >>> from ecfft_params_2_19 import params
    >>> demo(params, size=8)
"""
...
def verify():
    ...
    Verify that the parameters are correct:
      ...
      3. The generator has order exactly 2^19
